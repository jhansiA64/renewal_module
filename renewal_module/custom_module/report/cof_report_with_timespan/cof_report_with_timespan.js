...
frappe.query_reports["COF Report With Timespan"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	"formatter": function(value, row, column, data, default_formatter) {
		if (column.fieldname == "customer_order_form" && column.options == "Item" && data && data.indent == 0) {
			column._options = "Customer Order Form";
		} else {
			column._options = "";
		}
