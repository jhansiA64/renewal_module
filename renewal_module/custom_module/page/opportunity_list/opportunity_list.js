 ...
 */
  ...
  showRightPanelPersonCard(details = {}) {
    ...
    <div class="panel-person-head">
      ...
      <button type="button" class="panel-person-close">Close</button>
    </div>
      ...
      .on("click", "a[data-action]", (e) => {
        ...
        if (action === "create_supplier_quotation") {
          frappe.model.open_mapped_doc({
            method: "renewal_module.custom_module.page.opportunity_list.opportunity_list.make_supplier_quotation_from_opportunity",
            source_name: name,
          });
          return;
        }
