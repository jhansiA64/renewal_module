...
class contactsPage {
	...
	applyRoleBasedActionVisibility() {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.contacts.contacts.get_contacts_permissions",
			callback: (r) => {
				if (r.message) {
						...
						<div class="controls-wrapper">
							<div class="controls">
								...
								<div class="right-controls">
									...
									<a id="new-contacts-btn" href="/app/contacts/new-contacts" class="btn btn-sm btn-primary mr-2">
