...
@frappe.whitelist()
def get_contacts_permissions():
    """
    Returns boolean dictionary indicating if the current user has 
    'write' and 'delete' permissions for 'Contact' doctype.
    """
    return {
        "write": frappe.has_permission("Contact", "write"),
        "delete": frappe.has_permission("Contact", "delete"),
        "export": frappe.has_permission("Contact", "export"),
        "print": frappe.has_permission("Contact", "print")
    }
