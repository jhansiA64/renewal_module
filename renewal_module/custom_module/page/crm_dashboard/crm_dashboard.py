...
@frappe.whitelist()
def get_brand_wise_data_lw(sales_person=None):
    filters_data = {
    "based_on": "Expected Date",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_item_group_wise_data_lw(sales_person=None):
    filters_data = {
    "based_on": "Expected Date",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_closed_won_amount_tm(sales_person=None):
...
@frappe.whitelist()
def get_closed_lost_amount_tm(sales_person=None):
    filters_data = {
    "based_on": "Expected Date",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_renewal_count_tm(sales_person=None):
...
@frappe.whitelist()
def get_renewal_amount_tm(sales_person=None):
    # frappe.msgprint(sales_person)
    filters_data = {
    "based_on": "Creation",
    "brand": [],
...
@frappe.whitelist()
def get_profit_amount_tm(sales_person=None):
    filters_data = {
    "based_on": "Expected Date",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
