...
frappe.pages['review-dashboard'].on_page_load = function (wrapper) {
	frappe._review_dashboard_page = new Mypage(wrapper);  // Store instance globally
	/*if (frappe._review_dashboard_page) {
		console.log("review Dashboard page loaded successfully");
	} else {
		console.error("Failed to initialize review Dashboard page");
	}*/
};
...
class Mypage {
	...
	bindEvents() {
		...
		const updateOpportunityCount = () => {
			...
			this.brand_wise_donut_chart_lw(sales_person, time_filter1);
			this.Item_group_donut_chart_lw(sales_person, time_filter1);
		...
		//console.log("salespersondropdown3", salesDropdown3);
		const updateOppCountLw = () => {
			let sales_person = salesDropdown3.value || "";
			//console.log("Trigger update with:", sales_person);
			//last week
		...
		const updatesalesstageCount = () => {
			let sales_person = salesDropdown4.value || "";
			let time_filter4 = timeFilter4.value || "";

			this.loadData(time_filter4, sales_person);
		}
				...
				if (r.message && $dropdown.length) {
					...
					setTimeout(() => {
						if (r.message.length === 1) {
							$dropdown.val(r.message[0]);
							localStorage.setItem("sales_person", r.message[0]);
							$dropdown.trigger("change");
							me.update_dashboard_data(r.message[0]); // 👈 Add this line
						} else if (storedSalesPerson && r.message.includes(storedSalesPerson)) {
							$dropdown.val(storedSalesPerson);
							localStorage.setItem("sales_person", storedSalesPerson);
							$dropdown.trigger("change");
							me.update_dashboard_data(storedSalesPerson); // 👈 Add this line
						} else {
							$dropdown.val("");
							localStorage.setItem("sales_person", "");
							$dropdown.trigger("change");
							me.update_dashboard_data(""); // Already here
						}
					}, 100);
	...
	get_calls_count(sales_person = null) {
		...
		$("#calls-count").text(0);
		frappe.call({
			method: "renewal_module.custom_module.page.review_dashboard.review_dashboard.get_calls_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_training_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.review_dashboard.review_dashboard.get_training_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_sessions_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.review_dashboard.review_dashboard.get_sessions_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	brand_wise_donut_chart_lw(sales_person = null, time_filter1 = "this week") {
		//console.log("brand lw salesperson", sales_person);
		setTimeout(() => {
			frappe.call({
	...
	Item_group_donut_chart_lw(sales_person = null, time_filter1 = "this week") {
	...
	sales_funnel_chart(sales_person = null, time_filter1 = "this month") {
		console.log("sales funnel", sales_person, time_filter1);
		setTimeout(() => {
			frappe.call({
	...
	brand_wise_donut_chart_tw(sales_person = null) {
		//console.log("brand tw salesperson", sales_person);
		setTimeout(() => {
			frappe.call({
	...
	Item_group_donut_chart_tw(sales_person = null) {
		//console.log("itemgroup tw salesperson", sales_person);
		setTimeout(() => {
			frappe.call({
	...
	get_target_amount(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.review_dashboard.review_dashboard.get_target_amount",
			args: { sales_person: sales_person },
			callback: (r) => {
	...
	loadData(timeFilter = "this week", sales_person = "") {
	...
	body: `
		<div class="tab-content">
			<div class="tab-pane fade show active" id="review-content" role="tabpanel" aria-labelledby="review-tab">
				...
				<div class="box1 row" style="border-radius:10px;padding:5px; display:none;">
				...
				<div class="row mt-2" style="border-radius:10px;background-color:#F3F3F3;display:none;">
					...
					<div class="col-12 col-md-6 col-lg-3 mb-1">
						<div class="card1 card1-flush w-100 h-100 lg-100">
							...
							<div class="card1-body" style="height:auto;">
								<div id="item_group_donut_chart_"></div>
							</div>
						</div>
					</div>
				...
				<div class="row mt-2" style="border-radius:10px;background-color:#F3F3F3">
					...
					<div class="col-12 col-md-12 col-lg-6 mb-1" style="display:none;">
				...
				<div class="row mt-2" style="border-radius:10px;background-color:#F3F3F3">
					...
					<div class="col-6 col-md-2 col-lg-2">
						<div class="row mb-2 ms-1 mt-1 me-1">
							<div class="widget number-widget-box show-card-popup2" data-type="rnwls_pending_count" data-widget-name="Rnwls Pending(Lw)"
							data-method="get_rnwls_pending_count">
								<div class="widget-head">
									<div class="widget-label">
										<div class="widget-title">
					...
					<div class="col-6 col-md-2 col-lg-2">
						<div class="row mb-2 ms-1 mt-1 me-1">
							<div class="widget number-widget-box show-card-popup2" data-type="rnwls_cofed_count" data-widget-name="Cofed Rnwls(Lw)"
							data-method="get_rnwls_cofed_count">
								<div class="widget-head">
									<div class="widget-label">
										<div class="widget-title">
