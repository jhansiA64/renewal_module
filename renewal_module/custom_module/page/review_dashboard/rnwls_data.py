...
from renewal_module.renewal_module.report.renewals_data.renewals_data import get_data, get_columns,get_chart_data
...
@frappe.whitelist()
def get_rnwls_new_opp_count(time_filter2,sales_person=None):
    filters_data = {
    "based_on": "Creation",
    "brand": [],
...
@frappe.whitelist()
def get_rnwls_cofed_count(time_filter2,sales_person=None):
    filters_data = {
    "based_on": "Creation",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_rnwls_lost_count(time_filter2,sales_person=None):
    filters_data = {
    "based_on": "Creation",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_rnwls_renewed_count(time_filter2,sales_person=None):
    filters_data = {
    "based_on": "Creation",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
...
@frappe.whitelist()
def get_rnwls_pending_count(time_filter2,sales_person=None):
    filters_data = {
    "based_on": "Creation",
    "brand": [],
    "company": "64 Network Security Pvt Ltd - TG",
