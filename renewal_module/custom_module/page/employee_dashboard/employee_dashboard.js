/*frappepages['employee-dashboard'].on_page_load = function(wrapper) {
...
frappe.pages['employee-dashboard'].on_page_load = function (wrapper) {
	frappe._employee_dashboard_page = new Mypage(wrapper);  // Store instance globally
};

frappe.router.on('change', () => {
	const route = frappe.get_route();
	if (frappe._employee_dashboard_page && route[0] !== "employee-dashboard") {
...
class Mypage {
	...
	brand_wise_donut_chart_lw(sales_person = null, time_filter1 = "this week", from_date = "", to_date = "") {
		//console.log("brand lw salesperson", sales_person,time_filter1,from_date,to_date);
		//setTimeout(() => {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_brand_wise_data_lw",
			args: {
	...
	Item_group_donut_chart_lw(sales_person = null, time_filter1 = "this week", from_date = "", to_date = "") {
		//console.log("itemgroup lw salesperson", sales_person);
		//setTimeout(() => {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_item_group_wise_data_lw",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
	...
	get_closed_won_amount_tm(sales_person = "", time_filter1 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closed_won_amount_tm",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
			...
			callback: function (r) {
				if (r.message) {
					let formatted_price = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(r.message[0] || 0);
	...
	get_closed_lost_amount_tm(sales_person = "", time_filter1 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closed_lost_amount_tm",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
	...
	get_renewal_count_tm(sales_person = "", time_filter1 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_renewal_count_tm",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
			...
			callback: function (r) {
				if (r.message) {
					...
					$("#renewal-count-tm").text(r.message[0] || 0).attr("title", r.message[0] || 0);
	...
	get_renewal_amount_tm(sales_person = "", time_filter1 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_renewal_amount_tm",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
	...
	get_profit_amount_tm(sales_person = "", time_filter1 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_profit_amount_tm",
			args: {
				sales_person: sales_person,
				time_filter1: time_filter1,
				from_date: from_date,
	...
	setup_widget_click_events() {
		...
		$(".show-card-popup").off("click").on("click", function () {
			...
			$(".custom-dropdown-wrapper .btn-text").each(function () {
				const defaultLabel = $(this).closest(".select-btn").attr("id")?.replace(/-/g, " ") || "";
				$(this).text("Select " + defaultLabel.replace(/\b\w/g, l => l.toUpperCase()));
			});
			$(".show-card-popup,.show-card-popup11").removeClass("selected-widget");
			$this.addClass("selected-widget");
			// Frappe call
			frappe.call({
				method: `renewal_module.custom_module.page.employee_dashboard.employee_dashboard.${method}`,
	...
	setup_widget_click_events11() {
		...
		$(".show-card-popup11").off("click").on("click", function () {
			...
			/*if (!clickedBrand && !clickedItemGroup) {
				console.log("Card click ignored. No donut filters active, hiding table if visible.");
				if (tableVisible) {
					$("#widget-container, #widget-filters").hide();
	...
	multiselectDropdown1() {
		...
		setupCustomDropdown({
			...
			onSelectionChange: function (selectedGroups) {
				...
				// Reset brand UI
				brandList.innerHTML = '';
				brandBtnText.textContent = "Select Brand";
				...
				const updateBrandList = (brands) => {
					...
					brandList.querySelectorAll(".item").forEach(item => {
						item.addEventListener("click", function () {
							...
							brandBtnText.textContent = labels.length > 15 ? labels.substring(0, 15) + "..." : (labels || "Select Brand");
						});
					});
				};
	...
	loadOppStatusChart(sales_person = "", time_filter5 = "this week", periodicity = "monthly", sales_stages = [], from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_opp_status_chart",
			args: {
				sales_person: sales_person,
	...
	setupOppChartAndTable() {
		...
		window.loadTableData = function (period, chartSalesStages = []) {
			...
			frappe.call({
				method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_opp_table_data",
				args: args,
				callback: function (r) {
	...
	get_rnwls_new_opp_count(sales_person = "", time_filter2 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.rnwls_data.get_rnwls_new_opp_count",
			args: {
				sales_person: sales_person,
	...
	get_rnwls_lost_count(sales_person = "", time_filter2 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.rnwls_data.get_rnwls_lost_count",
			args: {
				sales_person: sales_person,
				time_filter2: time_filter2,
				from_date: from_date,
	...
	get_rnwls_renewed_count(sales_person = "", time_filter2 = "this week", from_date = "", to_date = "") {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.rnwls_data.get_rnwls_renewed_count",
			args: {
				sales_person: sales_person,
				time_filter2: time_filter2,
				from_date: from_date,
	...
	setup_widget_click_events2() {
		...
		$(".show-card-popup2").on("click", function () {
			...
			$(".custom-dropdown-wrapper .btn-text").each(function () {
				const defaultLabel = $(this).closest(".select-btn").attr("id")?.replace(/-/g, " ");
				const formatted = defaultLabel ? defaultLabel.replace(/\b\w/g, l => l.toUpperCase()) : "Select";
				$(this).text("Select " + formatted);
			});
			...
			frappe.call({
				method: `renewal_module.custom_module.page.employee_dashboard.rnwls_data.${method}`,
				args: {
					time_filter2,
					sales_person,
					from_date,
	...
	get_open_opportunity_amount(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_open_opportunity_amount_tm",
	...
	get_target_amount(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_target_amount",
			args: { sales_person: sales_person },
			callback: (r) => {
	...
	get_achieved_amount_tm(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_achieved_amount_tm",
			args: { sales_person: sales_person },
			callback: (r) => {
				if (r.message) {
					let formatted_price = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(r.message[0]);
	...
	setup_widget_click_events5() {
		...
		function applyTableFilters5() {
			...
			//console.log("Selected Opportunity Types:", selectedOppTypes);
	...
	opportunity_target_chart(sales_person = null) {
		...
		setTimeout(() => {
			frappe.call({
				method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_opportunity_target_data",
				args: { sales_person: sales_person },
				callback: (r) => {
	...
	sales_target_chart(sales_person = null) {
		setTimeout(() => {
			frappe.call({
				method: "renewal_module.custom_module.page.employee_dashboard.target_data.get_target_data",
				args: { sales_person: sales_person },
				callback: (r) => {
	...
	target_category_wise_chart(sales_person = null) {
		setTimeout(() => {
			frappe.call({
				method: "renewal_module.custom_module.page.employee_dashboard.target_data.target_category_wise_chart_tm",
				args: { sales_person: sales_person },
				callback: function (r) {
					if (r.message) {
	...
	target_category_wise_overall_chart(sales_person = null) {
		setTimeout(() => {
			frappe.call({
				method: "renewal_module.custom_module.page.employee_dashboard.target_data.target_category_wise_overall_chart",
				args: { sales_person: sales_person },
				callback: function (r) {
					if (r.message) {
	...
	loadData(timeFilter = "this week", sales_person = "",from_date = "", to_date = "") {
		//console.log("salesperson of load data:", sales_person);
		//console.log("time-filter of load data:", timeFilter);
		if (!timeFilter) {
		...
		if (sales_person === null || sales_person === undefined) {
			...
			//sales_person = dropdown ? dropdown.value : null;
		...
		//const toDate = document.getElementById("to-date").value;
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.sales_stage.get_filtered_opportunities",
			args: {
	...
	renderDonutChart(canvasId, data, title) {
	...
	get_closure_opp_count_tw(sales_person = null) {
		...
		frappe.call({
			...
			args: { sales_person: sales_person },
			callback: function (r) {
				//console.log("closure opp count tw:",r.message);
				if (r.message) {
	...
	get_closures_rnwls_count_tw(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closures_rnwls_count_tw",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
	...
	get_closures_rnwls_amount_tw(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closures_rnwls_amount_tw",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let formatted_price = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(r.message[0]);
	...
	Item_group_donut_chart_tw(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_item_group_wise_data_tw",
			args: { sales_person: sales_person },
			callback: (r) => {
				if (r.message) {
	...
	get_closures_rnwls_count_tm(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closures_rnwls_count_tm",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
	...
	get_closures_rnwls_amount_tm(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_closures_rnwls_amount_tm",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let formatted_price = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(r.message[0]);
	...
	brand_wise_donut_chart_tm(sales_person = null) {
		...
		frappe.call({
			...
			callback: (r) => {
				//console.log("brand wise data:", r.message);
				if (r.message) {
					//console.log("brand wise data tm:", r.message);
	...
	Item_group_donut_chart_tm(sales_person = null) {
		...
		//setTimeout(() => {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_item_group_wise_data_tm",
			args: { sales_person: sales_person },
			callback: (r) => {
				if (r.message) {
					//console.log("itemgroup tm data", r.message);
	...
	get_leads_count(sales_person = null) {
		...
		$("#leads-count").text(0);
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_leads_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
	...
	get_quoted_count(sales_person = null) {
		...
		$("#quoted-count").text(0);
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_quoted_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_demo_count(sales_person = null) {
		...
		$("#demo-count").text(0);
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_demo_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_new_customer_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_new_customer_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_appointment_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_appointment_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_client_visit_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_client_visit_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_calls_count(sales_person = null) {
		...
		$("#calls-count").text(0);
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_calls_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_training_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_training_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_sessions_count(sales_person = null) {
		...
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_sessions_count",
			args: { sales_person: sales_person },
			callback: function (r) {
				if (r.message) {
					let count = r.message || 0;
	...
	get_weekly_activity_data(sales_person = null) {
		...
		let self = this;
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.employee_dashboard.get_weekly_activity_data",
			args: { sales_person: sales_person },
			callback: (r) => {
	...
	get_calls_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_calls_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_appointments_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_appointments_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_demos_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_demos_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_leads_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_leads_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_sessions_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_sessions_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_trainings_tm(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_trainings_tm",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_fixed_amount(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_fixed_amount",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	get_variable_amount(sales_person = null) {
		frappe.call({
			method: "renewal_module.custom_module.page.employee_dashboard.activity_target.get_variable_amount",
			args: { sales_person: sales_person },
			callback: (response) => {
				if (response.message) {
	...
	setup_widget_click_events6 = function () {
		...
		$(".show-card-popup6").on("click", function () {
			...
			frappe.call({
				method: `renewal_module.custom_module.page.employee_dashboard.activity_target.${method}`,
				args: {
					sales_person
				},
				callback: function (r) {
			...
			<div class="tab-pane fade show active" id="review-content" role="tabpanel" aria-labelledby="review-tab">
				...
				<div class="row mt-2 d-flex align-items-stretch" style="border-radius:10px;background-color:#F3F3F3">
					<div class="col-12 col-md-12 col-lg-5 col-xl-5 d-flex flex-column">
						...
						<div class="row">
							<div class="col-6 col-md-3 col-xl-6 col-lg-6 mb-2">
								...
								<div class="filter-section-responsive" id="filter-section5">
									...
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="sales-stage5">
											<span class="btn-text">Select Sales Stage</span>
									...
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="opportunity-type5">
											<span class="btn-text">Select Opportunity Type</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
											<div class="search-box">
									...
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="item-group-filter5">
											<span class="btn-text">Select Item Group</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
											<div class="search-box">
									...
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="brand-filter5">
											<span class="btn-text">Select Brand</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
											<div class="search-box">
						...
						<div class="card p-2">
							<div class="d-flex align-items-center justify-content-between mb-3 flex-nowrap">
								...
								<div class="filter-section-responsive" id="filter-section1">
									<!-- Sales Stage -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="sales-stage1">
											<span class="btn-text">Select Sales Stage</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Opportunity Type -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="opportunity-type1">
											<span class="btn-text">Select Opportunity Type</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Item Group -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="item-group-filter1">
											<span class="btn-text">Select Item Group</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Brand -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="brand-filter1">
											<span class="btn-text">Select Brand</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
							...
							<div id="widget-table-container">
								<table class="table">
									<thead></thead>
									<tbody id="widget-data-table11"></tbody>
								</table>
							</div>
						</div>
					</div>
				...
				<div class="row mt-2" style="border-radius:10px;background-color:#F3F3F3">
					...
					<div class="col-12 col-md-6 col-lg-6">
						<div class="row box3 mb-2 ms-1 mt-1 me-1">
							...
							<div class="widget number-widget-box show-card-popup2" data-type="rnwls_lost_count" data-widget-name="Lost Rnwls(Lw)"
							...
							<div class="widget number-widget-box show-card-popup2" data-type="rnwls_new_opp_count" data-widget-name="Rnwls New Opp(Lw)"
						...
						<div class="card p-2">
							<div class="d-flex align-items-center justify-content-between mb-3 flex-nowrap">
								...
								<div class="filter-section-responsive" id="filter-section2">
									<!-- Item Group -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="item-group-filter2">
											<span class="btn-text">Select Item Group</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Brand -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="brand-filter2">
											<span class="btn-text">Select Brand</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="Lead(lw)">
												<a class="sales-link2" data-base-url="https://64network.com/app/lead" target="_blank">
												Lead(lw) 
												</a>
											</span>
										</div>
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="Quoted(lw)">
												<a class="sales-link1" data-base-url="https://64network.com/app/opportunity?status=Quotation" target="_blank">
												Quoted(lw)
												</a>
											</span>
										</div>
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="Demo/poc(lw)">
												<a class="sales-link1" data-base-url="https://64network.com/app/opportunity?sales_stage=POC%2FDemos%2FWebinar%2FSession" target="_blank">
												Demo/poc(lw)
												</a>
											</span>
										</div>
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="New Customers(lw)">
												<a class="sales-link1" data-base-url="https://64network.com/app/customer" target="_blank">
												New Customers(lw)
												</a>
											</span>
										</div>
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="Appointment(lw)">
												<a class="sales-link2" data-base-url="https://64network.com/app/appointment" target="_blank">
												Appointment(lw)
												</a>
											</span>
										</div>
									...
									<div class="widget-label">
										<div class="widget-title">
											<span class="ellipsis" title="Calls(lw)">
												<a class="sales-link1" data-base-url="https://64network.com/app/call-list" target="_blank">
												Calls(lw)
												</a>
											</span>
										</div>
					...
					<div class="col-12 col-md-12 col-lg-6 col-xl-6">
						<div style="width:100%; height:180px; border-radius:10px; padding:5px; overflow: hidden;">
							<div class="widget number-widget-box h-100" data-widget-name="last week activity" style="height: 100%;">
								...
								<div class="widget-body" style="height: 130px;"> <!-- adjust this to leave space for header -->
						...
						<div class="card p-2">
							<div class="d-flex align-items-center justify-content-between mb-3 flex-nowrap">
								...
								<div class="filter-section-responsive" id="filter-section5">
									<!-- Sales Stage -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="sales-stage4">
											<span class="btn-text">Select Sales Stage</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Opportunity Type -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="opportunity-type4">
											<span class="btn-text">Select Opportunity Type</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Item Group -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="item-group-filter4">
											<span class="btn-text">Select Item Group</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
									...
									<!-- Brand -->
									<div class="custom-dropdown-wrapper">
										<div class="select-btn" id="brand-filter4">
											<span class="btn-text">Select Brand</span>
											<span class="arrow-dwn"><i class="fa-solid fa-chevron-down"></i></span>
										</div>
										<div class="list-items">
