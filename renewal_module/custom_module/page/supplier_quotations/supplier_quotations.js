		...
		bindTabEvents() {
			...
			$("#panel-save-btn").off("click").on("click", async function (e) {
				...
				if (activePanelType === "Appointment") {
					...
					const customer_details = ($("#panel-supplier-details").val() || "").trim();
        ...
        <div class="panel__form-body">
          ...
          <div id="panel-appointment-fields" class="panel-appointment-fields d-none">
            ...
            <div class="panel__field">
              ...
              <input type="text" class="panel__input" id="panel-supplier" placeholder="Supplier" />
            </div>

            <div class="panel__field">
              <label>Supplier Name</label>
              <input type="text" class="panel__input" id="panel-supplier-name" placeholder="Supplier Name" />
            </div>

            <div class="panel__row">
              <div class="panel__field">
                <label>Supplier Phone Number</label>
                <input type="text" class="panel__input" id="panel-supplier-phone-number" placeholder="Phone Number" />
              </div>

              <div class="panel__field">
                <label>Supplier Email</label>
                <input type="email" class="panel__input" id="panel-supplier-email" placeholder="user@example.com" />
              </div>
            </div>
            ...
            <div class="panel__field panel__field--grow">
              ...
              <textarea class="panel__input panel__textarea" id="panel-supplier-details" rows="6" placeholder="Supplier Details"></textarea>
            </div>
          </div>
