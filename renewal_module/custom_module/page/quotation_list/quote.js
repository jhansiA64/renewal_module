	...
	class quotationdatapage {
		...
		openNewOppItemWizardInline(presetOpportunityType = null, editItemData = null) {
			...
			const syncInlineFormData = () => {
				...
				itemData.description = String(pickFieldValue("#inline-wizard-description", itemData.description) || "").trim();
			...
			const renderInlineWizard = () => {
				...
				<div class="${panel3Class}" data-inline-panel="3">
					...
					<div class="new-opp-row one-col"><div class="new-opp-field"><label>Description</label><textarea id="inline-wizard-description" rows="3" class="form-control">${frappe.utils.escape_html(toPlainText(itemData.description || ""))}</textarea></div></div>
				</div>
