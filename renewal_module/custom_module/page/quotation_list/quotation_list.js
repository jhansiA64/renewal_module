...
const OPP_CFG = {
  ...
  DOCTYPE: "Quotation",
  TITLE_FIELD: "name",                  // Quotation uses "name" as title
...
class quotationdatapage {
  constructor(wrapper) {
    ...
    // Same-page route changes (quotation-list -> quotation-list/<name>)
    // may not always re-trigger on_page_show, so handle route transitions here.
  ...
  <div class="ticket-header detail-page-header">
    <div class="detail-page-title-head">
      ...
      <div class="title-right">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="javascript:void(0)">CRM</a></li>
          <li class="breadcrumb-item"><a href="/app/quotation-list">Quotations</a></li>
        </ol>
      </div>
    </div>
      ...
      <div class="quotation-list-new d-none">
        <div class="new-quotation-wrap">
          ...
          <div class="new-opp-footer mt-2">
            ...
            <button class="btn btn-primary1" id="new-opp-save" type="button">Create Quotation</button>
          </div>

          <div class="new-quotation-card">
            <div class="card__title">New Quotation</div>
            ...
            <div class="new-quotation-form">
              ...
              <div class="new-opp-row one-col mt-2">
                <div class="new-opp-field">
          ...
          <div class="new-quotation-card mt-3">
            <div class="new-quotation-form">
