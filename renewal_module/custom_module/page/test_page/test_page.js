...
frappe.pages['test-page'].on_page_load = function(wrapper) {
    loadCssFile("/assets/css/bootstrap.min.css");
    loadCssFile("/assets/css/icons.min.css");
    loadCssFile("/assets/css/app.min.css");
    ...
    // Combine parts 1 to 4 as HTML and inject into the page
    page.body.innerHTML =  `
    <!DOCTYPE html>
<html lang="en">


<!-- Mirrored from coderthemes.com/ubold/html/tickets-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Sep 2025 10:09:03 GMT -->
<head>
    <meta charset="utf-8">
    <title>Support Tickets | UBold - Responsive Bootstrap 5 Admin Dashboard</title>
                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="ticket-create.html" class="btn btn-primary">
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody class="text-nowrap">
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2451</a></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                                        <a href="ticket-details.html" class="btn btn-default btn-icon btn-sm rounded"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="ticket-create.html" class="btn btn-default btn-icon btn-sm rounded"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2517</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2518</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2519</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2520</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2521</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2522</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2523</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2524</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2525</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2526</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="ticket-details.html" class="fw-semibold link-reset">#SUP-2527</a></td>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
...
<!-- Mirrored from coderthemes.com/ubold/html/tickets-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Sep 2025 10:09:04 GMT -->
</html>
    `;
