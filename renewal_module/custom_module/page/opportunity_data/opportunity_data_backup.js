...
class opportunitydatapage {
	...
	openNewOppItemWizardInline(presetOpportunityType = null, editItemData = null) {
		...
		const inDetailView = $scope.find(".opportunity-data-details:visible").length > 0;
		...
		if (isEditMode) {
			...
			itemData.description = me.richTextToPlainText(itemData.description || itemData.description_html || "");
		}
		...
		const toPlainText = (value) => me.richTextToPlainText(value);
		...
		const syncInlineFormData = () => {
			const $root = $body;
			const selectedOpportunityType = String($root.find("#inline-wizard-opportunity-type").val() || itemData.opportunity_type || "").trim();
			...
			itemData.spq_rate = Number($root.find("#inline-wizard-spq-rate").val()) || 0;
			itemData.expected_date = String($root.find("#inline-wizard-expected-date").val() || "").trim();
			itemData.forecast = String($root.find("#inline-wizard-forecast").val() || itemData.forecast || "Include").trim() || "Include";
			itemData.sales_stage = String($root.find("#inline-wizard-sales-stage").val() || itemData.sales_stage || "Initial Analysis").trim() || "Initial Analysis";
		...
		const ensureItemCodeControl = () => {
			...
			// Ensure the input field is properly visible and styled
			$host.find(".frappe-control, .form-group, .control-input-wrapper, .control-input").css({
				"display": "block",
				"width": "100%",
				"margin": "0"
			});
			$host.find("input.form-control, input[data-fieldtype='Link']").css({
				"display": "block",
				"width": "100%",
				"height": "34px"
			});
		...
		const ensureRenewalControl = () => {
			...
			// Ensure the input field is properly visible and styled
			$renewalHost.find(".frappe-control, .form-group, .control-input-wrapper, .control-input").css({
				"display": "block",
				"width": "100%",
				"margin": "0"
			});
			$renewalHost.find("input.form-control, input[data-fieldtype='Link']").css({
				"display": "block",
				"width": "100%",
				"height": "34px"
			});
		...
		const refreshInlineSummaryFields = () => {
			if (!isSessionActive()) return;
			const summaryPairs = [
				["#inline-summary-item-code", String(itemData.item_code || "").trim() || "-"],
				["#inline-summary-item-name", String(itemData.item_name || "").trim() || "-"],
				["#inline-summary-qty", String(itemData.qty ?? "") || "-"],
				["#inline-summary-rate", fmtCurrency(itemData.rate)],
				["#inline-summary-buying-rate", fmtCurrency(itemData.spq_rate)],
				["#inline-summary-expected-date", String(itemData.expected_date || "").trim() || "-"],
				["#inline-summary-forecast", String(itemData.forecast || "").trim() || "-"],
				["#inline-summary-description", String(itemData.description || "").trim() || "-"],
				["#inline-summary-orc", Number(itemData.orc || 0) ? "Yes" : "No"],
				["#inline-summary-commission-type", String(itemData.commission_type || "").trim() || "-"],
				["#inline-summary-rate-value", fmtCurrency(itemData.rate_value)],
				["#inline-summary-opportunity-type", String(itemData.opportunity_type || "").trim() || "-"],
				["#inline-summary-sales-stage", String(itemData.sales_stage || "").trim() || "-"],
				["#inline-summary-amount", fmtCurrency(itemData.amount)],
				["#inline-summary-margin", fmtCurrency(itemData.margin)],
			];
		...
		const renderInlineWizard = () => {
			...
			const panel4Class = currentWizardStep === 4 ? "" : "d-none";
			const panel5Class = currentWizardStep === 5 ? "" : "d-none";
			const panel6Class = currentWizardStep === 6 ? "" : "d-none";
			const panel7Class = currentWizardStep === 7 ? "" : "d-none";
			...
			$body.html(`
				<div class="new-opp-item-wizard-inline-stepper">
					...
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 2 ? "is-active" : ""} ${currentWizardStep > 2 ? "is-done" : ""}"><span class="dot">2</span><span>Item</span></div>
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 3 ? "is-active" : ""} ${currentWizardStep > 3 ? "is-done" : ""}"><span class="dot">3</span><span>Pricing</span></div>
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 4 ? "is-active" : ""} ${currentWizardStep > 4 ? "is-done" : ""}"><span class="dot">4</span><span>Forecast</span></div>
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 5 ? "is-active" : ""} ${currentWizardStep > 5 ? "is-done" : ""}"><span class="dot">5</span><span>ORC</span></div>
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 6 ? "is-active" : ""} ${currentWizardStep > 6 ? "is-done" : ""}"><span class="dot">6</span><span>Stage</span></div>
					<div class="new-opp-item-wizard-inline-step ${currentWizardStep === 7 ? "is-active" : ""}"><span class="dot">7</span><span>Summary</span></div>
				</div>
				...
				<div class="${panel4Class}" data-inline-panel="4">
					...
					<div class="new-opp-row one-col"><div class="new-opp-field"><label>Forecast Description</label><textarea id="inline-wizard-description" rows="3" class="form-control">${frappe.utils.escape_html(itemData.description || "")}</textarea></div></div>
				</div>
				...
				<div class="${panel7Class}" data-inline-panel="7">
					<div class="new-opp-inline-sub-card">
						<div class="new-opp-row two-col" style="margin-bottom:0;">
							<div class="new-opp-field"><label>Item Code</label><div id="inline-summary-item-code" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Item Name</label><div id="inline-summary-item-name" class="new-opp-display-value">-</div></div>
						</div>
						<div class="new-opp-row four-col" style="margin-bottom:0; margin-top:12px;">
							<div class="new-opp-field"><label>Qty</label><div id="inline-summary-qty" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Rate</label><div id="inline-summary-rate" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Buying Rate</label><div id="inline-summary-buying-rate" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Expected Closing Date</label><div id="inline-summary-expected-date" class="new-opp-display-value">-</div></div>
						</div>
						<div class="new-opp-row two-col" style="margin-bottom:0; margin-top:12px;">
							<div class="new-opp-field"><label>Forecast</label><div id="inline-summary-forecast" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Opportunity Type</label><div id="inline-summary-opportunity-type" class="new-opp-display-value">-</div></div>
						</div>
						<div class="new-opp-row two-col" style="margin-bottom:0; margin-top:12px;">
							<div class="new-opp-field"><label>Sales Stage</label><div id="inline-summary-sales-stage" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>ORC</label><div id="inline-summary-orc" class="new-opp-display-value">-</div></div>
						</div>
						<div class="new-opp-row two-col" style="margin-bottom:0; margin-top:12px;">
							<div class="new-opp-field"><label>Commission Type</label><div id="inline-summary-commission-type" class="new-opp-display-value">-</div></div>
							<div class="new-opp-field"><label>Rate Value</label><div id="inline-summary-rate-value" class="new-opp-display-value">-</div></div>
						</div>
						<div class="new-opp-row two-col" style="margin-bottom:0; margin-top:12px;">
						...
						<div class="new-opp-row one-col" style="margin-bottom:0; margin-top:12px;"><div class="new-opp-field"><label>Forecast Description</label><div id="inline-summary-description" class="new-opp-display-value">-</div></div></div>
					</div>
				</div>
				...
				<div class="new-opp-item-wizard-inline-actions">
					...
					<div class="new-opp-item-wizard-inline-actions-right">
						...
						<button type="button" class="btn btn-primary1 ${currentWizardStep >= 7 ? "d-none" : ""}" id="inline-wizard-next">Next</button>
						<button type="button" class="btn btn-primary1 ${currentWizardStep < 7 ? "d-none" : ""}" id="inline-wizard-save">${isEditMode ? "Update Item" : "Add Item"}</button>
					</div>
				</div>
			`);
			...
			$body
				...
				.on("input.newOppInlineWizard", "#inline-wizard-rate-value, #inline-wizard-description, #inline-wizard-supplier", function () {
					syncInlineFormData();
					refreshInlineSummaryFields();
				})
				...
				.on("click.newOppInlineWizard", "#inline-wizard-next", async function (e) {
					...
					if (currentWizardStep === 3 && !String(itemData.expected_date || "").trim()) {
						frappe.msgprint(__("Expected Closing Date is mandatory."));
						return;
					}

					currentWizardStep = Math.min(7, currentWizardStep + 1);
					renderInlineWizard();
				})
	...
	openNewOppItemWizard(presetOpportunityType = null, editItemData = null) {
		...
		const wizardToPlainText = (value) => me.richTextToPlainText(value);
	...
	async pickRenewalPresetItem(opportunityType = "Renewal", customerName = "") {
		...
		return await new Promise((resolve) => {
			...
			const loadRows = async () => {
				...
				try {
					const response = await frappe.call({
						method: "renewal_module.custom_module.page.opportunity_data.opportunity_data.search_active_renewal_presets",
						args: {
...
/*
		...
		if (directCandidateExists && isOrcEnabled && qty > 0 && /[a-z%]+$/i.test(directCandidateText)) {
			...
			const sourceAmount = commissionAmount > 0
				...
				: (directCandidateExists ? rateValue : 0);
							...
							spq_rate: Number(preset.spq_rate || 0),
							spq_amount: Number(preset.spq_amount || (Number(preset.qty || 1) * Number(preset.spq_rate || 0))) || 0,
							margin: Number(preset.margin || ((Number(preset.qty || 1) * Number(preset.rate || 0)) - (Number(preset.qty || 1) * Number(preset.spq_rate || 0)))) || 0,
							orc: Number(preset.orc || 0) ? 1 : 0,
							commission_type: String(preset.commission_type || ""),
							rate_value: Number(preset.rate_value || 0),
							sales_stage: String(preset.sales_stage || sourceDoc.sales_stage || ""),
				...
				<div class="row" style="row-gap:10px;">
					...
					<div class="col-md-12">
						<div class="item-edit-four-col-row">
							...
							<div class="item-edit-four-col-field"><label>SPQ Rate</label><input type="number" step="0.01" min="0" class="form-control item-edit-input item-edit-spq-rate" value="${spqRate}"></div>
							<div class="item-edit-four-col-field"><label>Expected Closing Date</label><input type="date" class="form-control item-edit-input item-edit-closure-date" value="${frappe.utils.escape_html(closureDate || "")}"></div>
						</div>
					</div>
	...
	`;
		...
		if ($descHolder.length && frappe?.ui?.form?.make_control) {
			...
			descCtrl.set_value(this.richTextToPlainText(row?.description || ""));
