...
class opportunitydatapage {
	...
	openNewOppItemWizardInline(presetOpportunityType = null, editItemData = null) {
		...
		const refreshInlineItemMetaFields = () => {
			...
			const $itemStepNameDisplay = $body.find("[data-inline-panel='2'] .new-opp-display-value");
		...
		const refreshInlineSummaryFields = () => {
			...
			const summaryPairs = [
				...
				["#inline-summary-orc", Number.isFinite(Number(itemData.spq_amount)) ? fmtCurrency(itemData.spq_amount) : "-"],
